...
## 31/03/2017 - jtucker@pixitmedia.com
## Added a minor modification to support NFS Shares from RRDNS provided servers
...
if [ $# -lt 1 ] || [ $# -gt 2 ]; then
	...
	echo "      : $0 <ip_of_nfs_server>:<nfs_server_export> <optional_capture_device>"
        exit 1
fi
nfs_server=$1
...
# This should not fail, but is less accurate than the RRDNS regex
# I.E. 999.000.999.000 is valid
